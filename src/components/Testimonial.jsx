    ...
    <MDBContainer className="py-5">
      <div className="container" data-aos="fade-up">
        <div className="section-title">
          <h2>Testimonials</h2>
          <p>Some opinions from Our Clients</p>
        </div>
      </div>
            ...
            <MDBContainer>
              <MDBRow className="text-center">
                <MDBCol lg="4" className="mb-5 mb-md-0">
                  ...
                  <h5 className="text-secondary mb-3">Anna Deynah</h5>
                  <h6 className="text-secondary mb-3">UX Designer</h6>
                  <p className="text-secondary px-xl-3">
                ...
                <MDBCol lg="4" className="d-none d-lg-block">
                  ...
                  <h5 className="text-secondary mb-3">John Doe</h5>
                ...
                <MDBCol lg="4" className="d-none d-lg-block">
                  ...
                  <h5 className="text-secondary mb-3">Maria Kate</h5>
            ...
            <MDBContainer>
              <MDBRow className="text-center">
                ...
                <MDBCol lg="4" className="d-none d-lg-block">
                  ...
                  <h5 className="text-secondary mb-3">Alex Rey</h5>
                  <h6 className="text-primary mb-3">Web Developer</h6>
                  <p className="text-secondary px-xl-3">
                    <MDBIcon fas icon="quote-left" className="pe-2" />
                    Ut enim ad minima veniam, quis nostrum exercitationem ullam
